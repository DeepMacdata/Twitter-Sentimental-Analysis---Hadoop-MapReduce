...
IntWritable>{
	...
	word.set(tuple[i]);
	String temp = Integer.toString(sentiment_sum);
	IntWritable val = new IntWritable(Integer.parseInt(temp));
	...
	DistributedCache.addCacheFile(new URI("/input/AFINN1.txt"),conf);
